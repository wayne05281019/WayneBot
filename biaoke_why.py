...
_TOPICS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "a": (
            ...
            "他改下星期二（教師節周一放假）有效過 3595 才算主升。待驗證，不是保證、不是買訊。"
            "9/18／9/21／9/22 這機還沒這列，不准用 Yahoo 冒充官方。"
            "健策為何真突破：9/1 高 6095；9/15 轉折K 收 5310 量 2469；9/23 收 6410 當日高、收過 9/1 高。"
            "台燿為何不像聯發科噴：9/17 低 1275 沒破；9/23 高 1485 仍在 8/14 高 1730 下。聯發科 9/23 收 5185 已過高。"
            "全新為何沒這麼快：9/17 量 28618，9/23 量 3310 收 552 回測 9/2 高 552，整理未完成。"
            "金像電 9/23 高 1140 還沒過他點的 1245。"
