...
_TOPICS: List[Dict[str, Any]] = [
    {
        ...
        "a": (
            ...
            "這一組細微波：9/14 叫本波修正末端、頭肩底頸線沒破；21:50 第五波再一次測底、短線築底等反彈。"
            "最差 C-1，C-2 轉 C-3 言之過早，出現會發文。"
            "7/29 他抄底、7/31 收成 A 波低（官方加權低 39385），自稱憑細微波抓轉折最準。"
            "官方 9/14 低已低於 45839、收還站上——右肩低不破前低這根先當有事，他改用頭肩底頸線，兩套一起留。"
