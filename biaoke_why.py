...
_WHY_ASK = re.compile(
    ...
    r"46746|45415|46250|46767|勤誠|8210|"
            ...
            r"量假結構|主力意圖|"
            r"聯茂|富世達|過中秋|新F|畫線|IC設計|一字鎖|3轉4)"
)
_TALK = re.compile(
...
_TOPICS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "a": (
            ...
            "官方 20260924 加權收 48024.60（證交所；較 9/23 收 48157.29 小跌 132.69）。"
            "官方個股 20260924："
            "創意 3443 開 8300 高 8545 低 8205 收 8525 量 1471；"
            "聯發科 2454 開 5105 高 5360 低 5105 收 5285 量 7817；"
            "健策 3653 開 6560 高 6920 低 6215 收 6920 量 2756（收在當日高）；"
            "奇鋐 3017 開 3460 高 3600 低 3455 收 3555 量 2261；"
            "聯茂 6213 開 595 高 595 低 592 收 595 量 16800（跳空鎖漲停，對得上他 09:54 那句）；"
            "台光電 2383 開 5025 高 5170 低 4980 收 5050 量 2346；"
            "台燿 6274 開 1485 高 1530 低 1475 收 1495 量 10047；"
            "全新 2455 開 547 高 555 低 542 收 554 量 1640；"
            "南亞科 2408 開 509 高 509 低 495 收 503 量 40244；"
            "富世達 6805 開 2570 高 2615 低 2505 收 2530 量 1046。"
            ...
            "為何奇鋐下週主升＝關前整理量價，不是發明 5／9、不是均線："
            "官方近高 20260907 高 3595 收 3420 量 3303（長上影關口）；"
            "8/26–9/4 攻段量 5242／6114／4035／4468／4515，關後量縮到兩千多～三千；"
            "20260923 開 3425 高 3590 低 3410 收 3470 量 2649＝回測近高差 5 元、量沒爆、不是轉弱K。"
            "20260924 高 3600 已碰過 3595、收 3555 量 2261 沒爆。他改下星期二（教師節周一放假）有效過 3595 才算主升。"
            "9/24 高碰到≠他說的下星期二確認。待驗證，不是保證、不是買訊。"
            "創意 9/18 這機還沒這列，不准用 Yahoo 冒充官方。9/21／9/22 已有官方柱：創意 20260921 開 7395 高 7755 低 7030 收 7615 量 3187；20260922 開 8370 高 8375 低 8370 收 8375 量 711（一字鎖）。"
            "健策為何真突破：9/1 高 6095；9/15 轉折K 收 5310 量 2469；9/23 收 6410 當日高、收過 9/1 高；9/24 再收 6920 當日高。"
            "台燿為何不像聯發科噴：9/17 低 1275 沒破；9/24 高 1530 仍在 8/14 高 1730 下。聯發科 9/24 收 5285 已過高。"
            "全新為何沒這麼快：9/17 量 28618，9/23 量 3310 收 552，9/24 量 1640 收 554，整理未完成。"
            "金像電 9/24 高 1150 還沒過他點的 1245。"
            ...
            "12:04 南亞科難短時間過前波高，比散熱弱。官方 9/24 收 503。"
            "11:43 四檔續航，不動資金至少 2～3 成抱到中秋後。不是買訊。"
            "11:52 44000＝波浪沒學通；修正跌到 47000 以下都是最後假跌破——他自己點的。"
            "18:32／18:34：技術分析核心＝量價結構；法人控盤長線龍頭比單一主力好讀；完全用裸K拆每根 K。不是新指標。"
            "19:26：富世達沒進新 F——奇鋐、健策、富世達最難抱住，主力畫線，無法用技術分析抓波段。官方 6805 9/24 收 2530 量 1046。"
            "22:33：抱 ASIC、散熱過中秋，連假後震盪較不怕；光通訊未必；CCL 震盪可能是最後布局點。不是買訊。"
    ...
    },
    {
        "id": "sep21-rotate",
        "keys": re.compile(
            r"(184846750|族群輪動.{0,12}死水|欣興.{0,12}壓力區|"
            r"空手者不要亂追|最差就是三|不要用無用的波浪|"
            r"市場黑手這波大盤任務|突破歷史新高之後.{0,8}拉回|"
            r"InP.{0,12}明年大盤|"
            r"3~4周整理|買拉回量縮)"
        ),
        "q": "9/21 族群輪動他怎麼看？",
        "a": (
            "2026-09-21 09:20 主文 184846750。同一串判斷，五件＝波浪／形態／量價／關鍵K／碎形線。"
            "個股不數 5／9。不准把波浪套個股。不是買訊。"
            "官方 20260921 加權收 47718.84（證交所；較前收漲 538.09）。"
            "官方個股 20260921："
            "欣興 3037 開 999 高 1055 低 999 收 1020 量 17461（對他「主力表態過壓力區」）；"
            "創意 3443 開 7395 高 7755 低 7030 收 7615 量 3187；"
            "聯發科 2454 開 4800 高 5035 低 4780 收 5010 量 11237；"
            "奇鋐 3017 開 3480 高 3495 低 3365 收 3415 量 1743；"
            "聯亞 3081 開 2900 高 2910 低 2820 收 2875 量 2610；"
            "全新 2455 開 571 高 590 低 545 收 572 量 15658。"
            "編號項分開記：① 族群輪動；昨講 ABF 死水，今開盤欣興過壓力；到原歷史高多要 3～4 周整理，操作 ABF 自己想空間。"
            "② 最強族群 ASIC；創意之外聯發科也過歷史高；空手不要亂追，突破後回測再判整理多久；散熱、光通訊很多突破又拉回。"
            "③ 光通訊持有要有耐心，像緩步攻堅、趨勢向上。"
            "④ 先前大漲族群買拉回量縮、看支撐再介入。"
            "⑤ 市場黑手任務＝突破歷史新高後拉回修正才算成功，否則反彈轉回升有相當疑慮。"
            "09:54 一層補⑤。10:22：不能見紅就追；長線主流緩步向上續抱如光通訊 InP、散熱。"
            "12:26：全新漲勢有連續，聯亞較慢仍會反彈；非 InP 光通訊普普。"
            "19:36：以全新為例量縮守撐＝不容易結束；股票不要用無用的波浪理論分析。"
            "19:37：大盤連第一個平台都沒出現，位階最差就是三還在運行中——他自己點的大盤位階，不准發明 5／9。"
            "19:42：InP 手握大量要有耐心；CCL 還要等量縮，今天欣興＝整理完成再買回測。"
            "20:31：InP 龍頭再差也會再測一次前高假突破結束行情；他認為光通訊 InP 到明年大盤行情結束是最重要新產業趨勢，如同 2025 年 CCL。待驗證。"
            "路人樓下不當他的判斷。"
        ),
    },
    {
        "id": "sep22-asic-ip",
        "keys": re.compile(
            r"(184874343|創意.{0,8}一字鎖|發哥沒回測|"
            r"炒ASIC.{0,12}IC設計|IP股|M31|"
            r"3轉4|下殺取量.{0,12}縮短|"
            r"台光電整理時間|散熱>光通訊|"
            r"高階測試.{0,8}洗盤|"
            r"大盤開始進入四整理)"
        ...
        "q": "9/22 ASIC／一字鎖他怎麼看？",
        "a": (
            "2026-09-22 樓下自回（主文 184874343 這包沒抓到正文，只收他的一／二層）。同一串判斷。"
            "個股不數 5／9。3 轉 4 是他自己的如果句（最差規劃波浪位階），不准當已確認、不准發明 5／9、不准把波浪套個股。不是買訊。"
            "官方 20260922 加權收 47800.17（證交所；較 9/21 收 47718.84 小漲 81.33）。"
            "官方個股 20260922："
            "創意 3443 開 8370 高 8375 低 8370 收 8375 量 711（一字鎖，對得上他 17:41）；"
            "聯發科 2454 開 5280 高 5480 低 5150 收 5180 量 12131（沒回測、收沒鎖）；"
            "台光電 2383 開 5100 高 5100 低 4855 收 4860 量 2101；"
            "全新 2455 開 570 高 570 低 537 收 547 量 18755；"
            "健策 3653 開 5985 高 6050 低 5780 收 5830 量 916；"
            "奇鋐 3017 開 3500 高 3505 低 3385 收 3390 量 2288。"
            "10:40：台光電整理原估 2～3 個月；上星期四利空後＝主力故意製造利空下殺取量，整理至少縮短 1 個月。小心和 ABF 同一情境、某時跳空漲停。待驗證。"
            "10:48：族群強弱散熱＞光通訊≧PCB＞＞高階測試。11:02：每天都在變，要動態調整。"
            "10:07：高階測試還在洗盤。"
            "11:40／11:41：市場主力炒 ASIC，不是其他 IC 設計或 IP；M31 是 IP 要小心。光通主流是 InP 不是 CPO／矽光子。"
            "12:00：創意比聯發科強因為純度高。"
            "12:11：大盤開始進入四整理可能性非常高——如果句，不是已確認。"
            "13:35：短線很多要調節；光通訊盤中大盤拉回也有調節，卡位 ASIC 低位階。"
            "16:56：全新明天 K 非常重要，點到為止。"
            "17:41：沒想到創意一字鎖、發哥沒回測持續漲。"
            "19:16：這波起漲 9/15 到今天 3 轉 4 可能性最大（最差規劃）；所以明天開始進行 abc 之後還有最後的 5 要完成。"
            "這是大盤如果句。官柱 9/23 加權收 48157、9/24 收 48024.60，abc／第 5 都還沒走完、不准提前升段。"
            "22:26：ASIC 強跟 Meta Muse 有關——產業面旁證，不改量價柱。路人樓下不當他的判斷。"
        ),
    },
    {
        "id": "wave-eyes",
...
def lookup(ask: str, *, limit: int = 4) -> str:
    ...
    if re.search(r"(準確度|對質結果|這次對了沒|學到什麼)", q):
        bits.append(
            "還沒到能講的那天。偷偷對質沒驗證完、他沒講怎麼操作，不准補操作。"
            "選股仍看現有高低卡。不是買訊，不准發明 5／9。"
        )
    try:
