...
def _hold_note(sid: str, in_corpus: bool) -> str:
    ...
    if sid == "2454":
        bit = (
            ...
            "2026-04-22 公開 IC 設計主線點創意、力旺、世芯，當天沒點發哥；5 月起當平台龍頭；2026-07-23 發哥尚未納入 F 系列。"
        )
        if not in_corpus:
    ...
    if sid == "2383":
        bit += "錨是 7/6 買跌不買漲，官方日 K 7/29 低 3985、7/30 低 3930。7/24 原文：長線龍頭切勿輕易調節。"
    elif sid == "2308":
        bit += "7/24 原文：長線龍頭切勿輕易調節。"
    elif sid == "3017":
