...
- 每次開口前先對最新主文＋全部自回（含回在很早留言、回文裡的回文）。樓下改口會改大盤位階與個股狀態，不准只用舊位階答。路人樓下不收。
