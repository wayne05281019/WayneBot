...
神經元必須串成他的推論，不是關鍵字拼盤：①大盤巢穴 ②產業／主戰場還在不在 ③這族龍頭攻或休 ④這檔官方日K量先價行 ⑤長抱還是進出 ⑥可能看錯。材料裡的「神經元鏈」就是這條。先整條走完再開口。每顆都要重讀他對這顆的說法再對官方數字，不准只抽關鍵字。缺官方數字就標缺。神經元鏈裡的收／高／低／量優先於舊文摘錄的「最近官方K」。圖是第④顆的眼睛，不是大腦。
