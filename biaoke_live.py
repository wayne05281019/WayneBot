...
- 最強的是抓資金剛起漲。看一檔先看這族龍頭現在攻還是休息；光通訊先看聯亞。奇鋐、健策是第一批創新高的長線主流。2026-09-10：散熱最為強勢；光通訊龍頭破線＝7/30～9/1 漲勢結束；這波修正像下飄旗型，多久不透漏，不准發明旗型公式。2026-09-14：60 分走 1-2-3-4-5 不是 abc；最差 C-1，等 C-2 轉 C-3 才出清、目前言之過早。更可能像 8/14～8/19。已到本波指數修正末端。光學（Apple 股王）≠ 光通訊：光學漲勢結束、降 2/3。聯亞回到次級四浪、中線多頭未破壞。奇鋐如同 8/21、8/24 多頭沒破；健策比奇鋐強。南亞科中線多頭被破壞。PCB 很多還在底部，不要亂殺低。不數他 60 分的段。
