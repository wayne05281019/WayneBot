...
PAGES: Sequence[Tuple[str, str, str]] = (
    ...
    (
        ...
        "\n"
        "第一排（左到右）\n"
        "說明　海選　持股　觀察　刷新　回報　飆客\n"
        "\n"
        "第二排（左到右）\n"
        "大盤　資金　當沖　隔日沖　AI倉　連買區　（一格空白）\n"
        "\n"
        "說明＝這本使用說明。海選＝昨天收盤掃出的名單。持股＝你手記的真實買入。觀察＝還沒買的自選。刷新＝只重畫上一檔，不是海選。打「決策卡」或「刷新上一檔」也行。回報＝畫面怪告訴偉權。飆客＝獨立觀點，跟海選無關。第二排最右一格空白還沒接。\n"
        "打「精簡選單」或「精簡鍵盤」只留說明／海選／持股、觀察／刷新／回報（都是兩個字）；「完整選單」或「完整鍵盤」恢復兩排。還沒查過請直接打代號（股票或 ETF）。",
    ),
    (
        "lookup",
        "查一檔：一次兩張圖",
