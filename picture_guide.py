...
PAGES: Sequence[Tuple[str, str, str]] = (
    (
        ...
        "3  三張圖出來後，最上是產業／報導則數（有真數才出現）；籌碼／營收在下一排\n"
        "\n"
    ...
    (
        ...
        "\n"
        "刷新＝只刷新上一檔決策卡，不是海選。打「決策卡」或「刷新上一檔」也行。還沒查過請直接打代號（股票或 ETF）。\n"
    ...
    (
        ...
        "3  圖下面最上：產業（一張圖卡，股名旁公開細項小框，沒抓到不畫）、報導則數（點開 Google 新聞自己讀，則數變多不是賣訊）。下一排籌碼、營收、觀察、記買入。零股寫「200股 631.6」\n"
        "\n"
