...
PAGES: Sequence[Tuple[str, str, str]] = (
    (
        ...
        "2  直接打代號看圖，例如 2330、0050、0052、00631L、00981A。不要先按「決策卡」\n"
    ...
    (
        ...
        "隔日沖　大盤　資金　連買區　說明　回報\n"
        "\n"
        "決策卡＝刷新上一檔，不是海選。還沒查過請直接打代號（股票或 ETF）。\n"
        "畫面怪按最右「回報」。",
    ),
    (
        "lookup",
        "直接打代號",
        "打股名或代號，例如 2330、0050、0052、00631L、00981A。不要先按「決策卡」。\n"
        "\n"
        "1  輸入列打代號或股名，送出就出圖\n"
        "2  一次出三張，點縮圖可放大\n"
    ...
    (
        ...
        "亂按沒關係。下面幾條最常見。\n"
        "\n"
        "1  一打開先按了「決策卡」：那顆是刷新上一檔。還沒查過就直接打代號\n"
