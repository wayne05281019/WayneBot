...
PAGES: Sequence[Tuple[str, str, str]] = (
    ...
    (
        ...
        "3  圖下面最上：產業（一張圖卡，股名旁公開細項小框，沒抓到不畫）、報導則數（點開 Google 新聞自己讀，則數變多不是賣訊）、K線（開 TradingView 看這檔日K，已帶代號；高低卡不會帶過去）。下一排籌碼、營收、觀察、記買入。零股寫「200股 631.6」\n"
        "\n"
    ...
    (
        ...
        "4  找不到產業或報導：在圖下面最上那一排。想問為什麼跌：左邊三條槓點「原因」\n"
