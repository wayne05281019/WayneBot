    ...
    if named:
        ...
        if sid == "2383":
            ...
            bits.append(
                ...
                "之後到 20260923 高都≤3590。20260923 開 3425 高 3590 低 3410 收 3470 量 2649＝回測近高、量較 8/26–9/4 攻段縮、"
                "不是爆量長上影轉弱K。下星期二主升＝待驗證有效過 3595，不是保證、不是買訊。"
                "9/18／9/21／9/22 這機 daily_quotes 還沒這列，不准編。"
            )
        elif sid == "3443":
            bits.append(
