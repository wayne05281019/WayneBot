...
_METHODS: List[Tuple[re.Pattern[str], str, str]] = [
    ...
    (
        ...
        "2026-07-24：台光電、台達電等長抱主流勿輕易調整。篤定＝產業趨勢還在＋對上大盤大跌窗口，不是把波浪套在 2383。"
    ...
    (
        re.compile(
            r"(F4|F10|長抱|持股不動|勿輕易調整|聯發科|IC設計主線|IC 設計主線|"
            r"抱著波段|波段賺|效率操作)"
        ),
        "長抱主流／F4→F10／聯發科",
        "他短打很準，但公開把長抱跟當下進出分開。2026-07-24：台光電、台達電等長抱主流勿輕易調整；"
...
NEURON_VIEWS: Dict[str, Tuple[str, ...]] = {
    ...
    "hold": ("長抱主流／F4→F10／聯發科", "半山腰只隔日沖", "洞燭先機"),
    "doubt": ("盲測要疊條件", "洞燭先機"),
}
