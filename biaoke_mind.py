...
_METHODS: List[Tuple[re.Pattern[str], str, str]] = [
    ...
    (
        ...
        "缺官方序列就抓。夜盤 15 分沒有就不數段；日盤 15 分有庫只報高低，不發明段。某金融商品沒點名，不准寫死。"
    ...
    (
        ...
        "46506＝官方台指期 20260910 日盤低，不是加權 9/10 低 46573。夜盤 15 分沒有，不數這則的段。"
    ...
    (
        ...
        "細微波、15 分、60 分、夜盤是大盤基本動作。不要把波浪百分之百套在個股。夜盤 15 分沒有就不數段。不是買訊。",
    ),
    (
