...
class FuseAndScreenTest(unittest.TestCase):
    ...
    def test_sector_rotation_uses_official_chips(self):
        ...
        try:
            ...
            self.assertIn("買超", flow)
            self.assertIn("外資", flow)
...
class TelegramAlignTest(unittest.TestCase):
    ...
    def test_html_holdings_qty_keeps_odd_lots(self):
        ...
        self.assertEqual(holdings_qty_text(1.439), "1張439股")
        self.assertEqual(html_holdings_qty(1.439), "<code>1張439股</code>")
        from tg_layout import holdings_qty_label

        self.assertEqual(holdings_qty_label(4), "張數")
        self.assertEqual(holdings_qty_label(0.439), "股數")
        self.assertEqual(holdings_qty_label(1.439), "數量")
    ...
    def test_holdings_html_shows_odd_lots_as_shares(self):
        ...
        try:
            ...
            self.assertIn("張數", html)
            self.assertIn("股數", html)
...
class LookupCardTest(unittest.TestCase):
    ...
    def test_profit_cell_uses_low_palette_not_hardcoded_pink(self):
        ...
        self.assertIn("wash_signal_cols = {2, 3, 4, 5}", src)
        self.assertNotIn("pill_cols = {2, 3, 4, 5}", src)
        self.assertNotIn("_paint_limit_square_center", src)
        self.assertIn("limit_chip", src)
        self.assertIn("peak_wash", src)
    ...
    def test_decision_card_png_hi_dpi_and_right_edge(self):
        ...
        self.assertNotIn("_paint_nav_on_axes", glance_src)
        self.assertNotIn("compact=True", glance_src)
