...
def test_pin_reply_menu_keeps_keyboard_message():
    ...
    from bot_servers import MENU_BTN_BIAOKE_FACE, MENU_BTN_LEAVE_ZERO, MENU_BTN_MARKET, MENU_BTN_REPORT, MENU_BTN_DONGZHU, MENU_BTN_STREAK
...
def test_refresh_silent_sends_reply_keyboard_with_streak():
    ...
    from bot_servers import MENU_BTN_BIAOKE_FACE, MENU_BTN_LEAVE_ZERO, MENU_BTN_MARKET, MENU_BTN_REPORT, MENU_BTN_DONGZHU, MENU_BTN_STREAK, WayneTelegramBot
