...
class IndexDailyOfficialChartTests(unittest.TestCase):
    ...
    def test_fmt_vol_says_lots_not_money(self):
        from index_kline_chart import _fmt_last_vol, _fmt_vol
        ...
        self.assertEqual(_fmt_last_vol(0), "—")
        self.assertEqual(_fmt_last_vol(None), "—")
        self.assertEqual(_fmt_last_vol(11201668), "1120.2萬張")
