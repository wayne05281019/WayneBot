...
def format_biaoke_desk_html() -> str:
    ...
    return (
        ...
        "4 量先價行：爆大量當日高低當壓／撐，量縮站上才進，否則放棄。懂量假結構才拿掉不穩指標；爆量長上影或收在當日下半不准當發動\n"
        ...
        "10 主音（波浪）他自己說不是 100%。確認低點要疊台積電量價、費半先行、夜盤是否過壓；單講趨勢向上／初步止訊號／右肩有守不夠\n"
        "\n"
        "<b>接著怎麼問</b>\n"
        "直接打字或按麥克風講即可，裡面沒有選單。我會用他的公開文加官方數字直接回你。"
