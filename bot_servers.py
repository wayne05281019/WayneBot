...
HELP_TOPICS = {
    ...
    "market": (
        ...
        "台股國定假／補假看證交所開休市表。颱風休市以人事行政總處為準：只有台北市宣布全日或上午停班，集中市場才休市；僅下午停班仍開市。前一晚 19:00–22:00 公告（23:00 前播出），沒公告則當天 04:30 前補發（05:00 前播出）；機器人 22:15（週日也抓）與 06:30 各讀一次該頁。\n"
        "\n"
    ...
    "screen": (
        ...
        "台股國定假或北市全日／上午停班當日，不寄今早海選、也不寄尾盤可切。\n"
