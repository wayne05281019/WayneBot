...
HELP_TOPICS = {
    "guide": (
        ...
        "大盤最上頭是時段跑馬燈：電子數字倒數試搓／台指期，整條從最左跑到最右；長住那一則自己換價，也可按「刷新跑馬燈」。\n"
        "\n"
        "<b>挑股認哪一欄（最重要）</b>\n"
    ...
    "row1": (
        ...
        "• AI倉：模擬帳戶在主選單第一排最右，不要跟手記持股搞混。平常最多 1 檔，超跌才第 2 檔，第 3 份留現金。\n"
        "\n"
        "<b>④ 觀察</b>\n"
        "• 是什麼：自選清單，還沒買也可以先放。\n"
    ...
    "market": (
        ...
        "最上頭是時段跑馬燈：整條從最左跑到最右，數字用電子錶字。開盤前倒數試搓／台指期；試搓中寫個股試搓價格中；9:00 起加權／櫃買／台指期；13:30 後日盤收、加權盤後、櫃買續跑；15:00 後寫加權／櫃買收盤與漲跌。沒接到不寫；長住那一則自己換價，也可按「刷新跑馬燈」。\n"
    ...
    "portfolio": (
        ...
        "• <b>成交</b>＝你手記的買賣紀錄\n"
        "• <b>復盤</b>＝對照昨收怎麼走\n"
        "• <b>AI倉</b>＝假錢對照組現況（不買賣）；主選單第一排最右也有。50 萬切 3 等份，不買滿\n"
        "\n"
