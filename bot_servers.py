...
HELP_TOPICS = {
    "guide": (
        ...
        "• <b>K線</b>　開這一檔可滑動的日K（不是 TradingView）：手指對價、可改 15 分／60 分，或五日／十日／月線／季線\n"
    ...
    "stock": (
        "<b>查股頁（圖下方按鈕）</b>\n"
        "打股名或按看這檔：一次出介紹圖、決策卡（相簿）。介紹圖下半已有 180 日高低導航。要滑動對價按圖下「K線」；原版 180 日高低圖按「導航圖」。\n"
        ...
        "• <b>K線</b>：可滑動日K；手指對價，可改 15 分／60 分／五日／十日／月線／季線\n"
        "• <b>觀察</b>：加入自選（還沒買）\n"
    ...
    "pick": (
        ...
        "一次出兩張圖：介紹圖（上半資訊、下半180日高低導航）→ 決策卡。要滑動對價按圖下「K線」。原版 180 日高低圖按「導航圖」。\n"
...
class WayneTelegramBot:
    ...
    def _em_no_listed_html(self, code: str, hits: list | None = None) -> str:
        ...
        return (
            ...
            "三大法人表興櫃沒有就不顯示。有日均價序列就出介紹圖／高低卡；圖下「導航圖」是原版 180 日高低圖，要滑動對價按「K線」。"
        )
