...
HELP_TOPICS = {
    ...
    "row2": (
        ...
        "\n"
        "<b>⑦ 洞燭先機</b>\n"
        "• 是什麼：佔比如實主判（CMoney 細項佔當日法人買超％升降）。飆大找法只參考、不是唯一。對五件只落在這族（波浪不數個股）。張數會被熱門族蓋過所以不拿來排名。\n"
    ...
    "dongzhu": (
        "<b>洞燭先機怎麼用</b>\n"
        "第二排最右。佔比如實主判：CMoney 細項佔當日法人買超％與％變化，流入＝佔比升、流出＝佔比降；不比張數、不抓分點。"
        "飆大教過的找法只參考、不是唯一：次族群還沒熱、第一名誰先過前高、從底部找落後。"
