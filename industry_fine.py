...
# 光通訊（矽光子）＝點名檔；IET＝IET-KY 4971。啞光＝亞光；通家＝通嘉；啟基＝啟碁；耀華＝燿華。
TAUGHT_GROUPS: Dict[str, tuple] = {
    ...
    "記憶體製造": ("2408", "2344", "2337", "3006", "5351"),  # 南亞科、華邦、旺宏、晶豪科、鈺創
    "記憶體控制": ("8299", "6485", "3588", "2451", "5269", "6104"),  # 群聯、點序、通嘉、創見、祥碩、創惟
    "ASIC": ("3443", "3661", "3035"),
    "散熱": ("3653", "3017"),
